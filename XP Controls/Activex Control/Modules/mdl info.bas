...
Global s_Title As String
Global s_Message As String
Global IMGS As Boolean
Global SetDefault As Boolean
Global IsDefPic As Object
Global MyType As Integer
Global ResponMsg As Integer
Global msgBackColor As Long
Global ResponInput As String
Public IsTitle As String
Public IsVersion As String
Public IsDevelover As String
Public IsEmail As String
Public IsPhone As String
